...
class Newsletters_Model extends CI_Model
{
	...
	*/
	public function getAll($limit = null, $offset = 0, $sort_by, $sort_order, $search = 'all')
	{
		...
		$sort_columns = array('id', 'name', 'created_at', 'submit_at');
		$sort_by = (in_array($sort_by, $sort_columns)) ? $sort_by : 'id';

		$result = array();
		$res = FALSE;

		$this->db->select('id, name, status, temp_id, created_at, submit_at');
...
/* Location: ./application/modules/admin/models/Newsletters_Model.php */ ?>