var j=jQuery.noConflict();(function(a){j(document).on("ready",function(){tinymce.init({selector:"textarea.edit-wysiwg",theme:"modern",height:600,document_base_url:_root_,remove_script_host:false,relative_urls:false,plugins:["advlist autolink link image code lists charmap print preview hr anchor pagebreak","searchreplace wordcount visualblocks visualchars insertdatetime media nonbreaking","table contextmenu directionality emoticons paste textcolor responsivefilemanager"],toolbar1:"undo redo | bold italic underline | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | styleselect",toolbar2:"| responsivefilemanager | link unlink anchor | image media | forecolor backcolor  | print preview code ",image_advtab:true,external_filemanager_path:_root_+"filemanager/",filemanager_title:"Responsive Filemanager",external_plugins:{filemanager:_root_+"filemanager/plugin.min.js"}});
...
j.post(_root_+"admin/newsletters/delete",{id:e},function(f){spin.stop();if(f){j(".content").load(_root_+"admin/newsletters/displayAjax");}});}else{spin.stop();
